...
<body>
    <div class="main-container">
        <!-- Food Images -->
        <img src="images/img_image_1.png" alt="Indonesian Traditional Food" class="food-image-1">
        <img src="images/img_92bdbb2f7c4e461e8d7608d91e7754c6.png" alt="Indonesian Cuisine Background" class="food-image-2">
        <img src="images/img_b707612e60454c568b29bc4e095a5c54_1.png" alt="Nusantara Food Collection" class="food-image-3">
        <img src="images/img_image.png" alt="Traditional Indonesian Dishes" class="food-image-4">
        <img src="images/img_image_2.png" alt="Local Indonesian Food" class="food-image-5">
        <img src="images/img_image_172x359.png" alt="Indonesian Street Food" class="food-image-6">
        ...
        <header class="header-section">
            ...
            <div class="language-selector" onclick="toggleLanguageDropdown()">
                ...
                <img src="images/img_icon.svg" alt="Language Icon" class="language-icon">
